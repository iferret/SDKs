...
//  BFPaperButton
//
//  Created by tramp on 2022/1/4.
//

#import <Foundation/Foundation.h>

//! Project version number for BFPaperButton.
FOUNDATION_EXPORT double BFPaperButtonVersionNumber;

//! Project version string for BFPaperButton.
FOUNDATION_EXPORT const unsigned char BFPaperButtonVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <BFPaperButton/PublicHeader.h>
